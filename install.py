...
def get_lldbinit_commands():
    ...
    commands = [
        ...
        f"command script import {SCRIPTS_DIR}",
        MARKER_END,
    ]
    return "\n".join(commands) + "\n"
...
def install():
    ...
    # Verify scripts directory and required files exist
    ...
    required_files = [
        ...
        SCRIPTS_DIR / "objc_breakpoint.py",
        SCRIPTS_DIR / "objc_sel.py",
        SCRIPTS_DIR / "objc_cls.py",
        SCRIPTS_DIR / "objc_call.py",
        SCRIPTS_DIR / "objc_watch.py",
        SCRIPTS_DIR / "objc_protos.py",
        SCRIPTS_DIR / "objc_pool.py",
        SCRIPTS_DIR / "objc_instance.py",
        SCRIPTS_DIR / "objc_utils.py",
        SCRIPTS_DIR / "version.py",
    ]
